  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fontSize(24).font("Helvetica-Bold").fillColor("#1a5c1a")
        .text("Add Life to Your Years", { align: "center" });
      doc.moveDown(0.3);
      ...
      doc.fontSize(9).font("Helvetica").fillColor("#999999")
        .text(
          "This report is generated by the Add Life to Your Years self-evaluation tool. It is intended for informational purposes only and does not constitute medical advice. Please consult with a qualified healthcare provider for personalised medical guidance.",
          { align: "center" }
        );
      doc.moveDown(0.3);
