...
export const CONDITION_KNOWLEDGE: ConditionKnowledge[] = [
  ...
  },
  {
    ...
    interventions: {
      ...
      offLabel:
        "EDUCATIONAL INFORMATION ONLY — NOT MEDICAL ADVICE: Research has identified potential anticancer properties in two off-patent generic drugs: Fenbendazole (veterinary antiparasitic; human equivalent mebendazole is FDA-approved) disrupts microtubule polymerisation, inhibits cancer cell glucose uptake, and may reactivate p53 tumour suppressor function. Ivermectin (Nobel Prize 2015; over 4 billion doses administered worldwide) inhibits the Akt/mTOR pathway, disrupts glycolysis, and promotes apoptosis. A 2021 Stanford/Washington University case series documented significant tumour regression in three advanced-cancer patients. The U.S. National Cancer Institute began formally studying ivermectin's anticancer properties in February 2026. NEW 2026 EVIDENCE — Hulscher et al. (Zenodo, April 7 2026, DOI: 10.5281/zenodo.19455636): The largest real-world human study of ivermectin + mebendazole in cancer to date. 197 cancer patients (prostate, breast, lung, colon, and others) received compounded ivermectin 25 mg + mebendazole 250 mg off-label. Clinical Benefit Ratio = 84.4% (95% CI: 77.0–89.8%): 48.4% reported tumour regression or no evidence of disease; 36.1% stable disease; 15.6% progression. Adherence 86.9%; 25.4% mild GI side effects, 93.6% continued treatment. Note: observational design with self-reported outcomes — preprint, not yet peer-reviewed. Authors call for randomised controlled trials. The absence of large-scale clinical trials reflects the economics of generic drug research, not evidence of inefficacy. NEVER self-medicate — always discuss with a qualified healthcare professional. See Appendix C in the book for full details, case reports, mechanisms, safety profiles, and references. Visit fenbendazole.org for comprehensive research information.",
    },
  },
  {
    id: "mental_health",
  ...
  },
  {
    ...
    overview:
      "IMPORTANT DISCLAIMER: This information is provided for educational purposes only. It does not constitute medical advice, diagnosis, or treatment. Always consult a qualified healthcare professional before starting, stopping, or changing any medication. Fenbendazole is a benzimidazole-class antiparasitic drug (veterinary) whose human equivalent mebendazole is FDA-approved. Ivermectin is a Nobel Prize-winning antiparasitic (2015, Omura & Campbell) with over 4 billion doses administered worldwide and WHO essential medicine status. Both are off-patent generic drugs that have attracted research interest for potential anticancer properties. Laboratory studies have identified multiple mechanisms: fenbendazole disrupts microtubule polymerisation, inhibits glucose uptake via GLUT transporters, and may reactivate p53 tumour suppressor function. Ivermectin inhibits the Akt/mTOR pathway, disrupts glycolysis, promotes apoptosis, and targets cancer stem cells. A 2021 Stanford/Washington University case series documented tumour regression in three advanced-cancer patients self-administering fenbendazole. As of February 2026, the U.S. National Cancer Institute announced formal study of ivermectin's anticancer properties. NEW 2026 EVIDENCE: Hulscher et al. (Zenodo, April 7 2026, DOI: 10.5281/zenodo.19455636) — the largest real-world human study of ivermectin + mebendazole in cancer to date. 197 cancer patients across multiple cancer types received compounded ivermectin 25 mg + mebendazole 250 mg off-label. Clinical Benefit Ratio = 84.4% (95% CI: 77.0–89.8%): 48.4% reported tumour regression or no evidence of disease; 36.1% stable disease; 15.6% progression. Note: observational design, self-reported outcomes, preprint not yet peer-reviewed — authors call for RCTs. The absence of large-scale RCTs reflects the economics of generic drug research (no patent protection = no financial incentive for trials), not evidence of inefficacy. For more information visit fenbendazole.org. See Appendix C in the book for full details, references, and the video presentation of this study.",
    symptoms:
