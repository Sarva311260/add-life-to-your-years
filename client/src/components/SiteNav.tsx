    ...
    <header className="sticky top-0 left-0 right-0 z-50 bg-white/85 backdrop-blur-md shadow-md border-b border-white/40">
      <div className="container flex items-center justify-between h-14">
        ...
        <Link href="/" className="flex items-center gap-2 shrink-0">
          <img src="/manus-storage/logo-favicon_d30c3a72.png" alt="Add Life to Your Years" className="w-9 h-9 object-contain rounded-full border-2 border-primary/60 p-0.5" />
