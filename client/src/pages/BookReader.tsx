...
const MD_CDN_URL = "/manus-storage/book-content_84240443.md";
...
const chapters = [
  ...
  { id: "appendix-i", label: "Appendix I: Lavender Oil" },
            ...
            <div ref={contentRef} className="max-w-3xl mx-auto book-content">
              ...
              <div className="flex flex-col items-center mb-12 pb-10 border-b border-stone-200">
                ...
                <div className="mt-4 flex gap-3">
                  <span className="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full font-medium">270 Pages</span>
