...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "gen_diabetes",
        text: "Do you have a personal or family history of diabetes?",
        description: "Including Type 1, Type 2, gestational diabetes, or pre-diabetes in yourself or close relatives.",
        type: "choice",
        isFlag: true,
        flagTriggerValues: [1, 2, 3],
        options: [
          { value: 1, label: "Yes \u2014 I have been diagnosed with diabetes" },
          { value: 2, label: "Yes \u2014 significant family history (parents or siblings)" },
          { value: 3, label: "Yes \u2014 both personal and family history" },
          { value: 4, label: "Minor or distant family history only" },
          { value: 5, label: "No known history of diabetes" },
        ],
      },
      {
        id: "gen_stroke",
        text: "Do you have a personal or family history of stroke?",
        description: "Including ischaemic stroke, haemorrhagic stroke, TIA (mini-stroke), or cerebrovascular disease.",
        type: "choice",
        isFlag: true,
        flagTriggerValues: [1, 2, 3],
        options: [
          { value: 1, label: "Yes \u2014 I have had a stroke or TIA" },
          { value: 2, label: "Yes \u2014 significant family history (parents or siblings)" },
          { value: 3, label: "Yes \u2014 both personal and family history" },
          { value: 4, label: "Minor or distant family history only" },
          { value: 5, label: "No known history of stroke" },
        ],
      },
      {
        id: "gen_7",
